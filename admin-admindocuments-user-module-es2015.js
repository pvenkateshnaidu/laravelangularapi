...
let UserListComponent = class UserListComponent {
    ...
    ngOnInit() {
        this.userRest.getTimeSheetDocuments().subscribe((response) => { console.log(this.timeSheets = response.documents); this.loading = false; }, (error) => { console.log(error); });
    }
...
//# sourceMappingURL=admin-admindocuments-user-module-es2015.js.map