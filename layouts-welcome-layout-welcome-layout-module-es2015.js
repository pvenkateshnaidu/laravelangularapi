...
let CommonAuthRoutingModule = class CommonAuthRoutingModule {
};
...
module.exports = ".text-muted {\n  text-align: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
let LoginComponent = class LoginComponent {
    ...
    login() {
        ...
        this.auth.logIn(this.loginForm).subscribe((response) => {
...
const WelcomeLayoutRouting = [
    {
        path: '',
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ../../auth/common-auth.module */ "./src/app/auth/common-auth.module.ts")).then(m => m.CommonAuthModule)
    }
];
...
let WelcomeLayoutModule = class WelcomeLayoutModule {
};
...
//# sourceMappingURL=layouts-welcome-layout-welcome-layout-module-es2015.js.map