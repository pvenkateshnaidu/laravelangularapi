...
var UserCreateComponent = /** @class */ (function () {
    ...
    UserCreateComponent.prototype.generatePDF = function () {
        var _this = this;
        ...
        html2canvas__WEBPACK_IMPORTED_MODULE_7___default()(data).then(function (canvas) {
            ...
            var pdf = new jspdf__WEBPACK_IMPORTED_MODULE_6__["default"]();
            var position = 0;
            pdf.addImage(contentDataURL, 'PNG', 0, position, imgWidth, imgHeight);
            pdf.save('invoice-payment.pdf');
        });
        this.userRest.storeInvoices(this.registerForm).subscribe(function (response) {
    ...
    UserCreateComponent.prototype.showBasicDialog = function () {
        this.displayBasic = true;
        console.log();
    };
    UserCreateComponent.prototype.showImage = function (data) {
    ...
    UserCreateComponent.prototype.ngOnInit = function () {
        ...
        this.userRest.getCountInvoices().subscribe(function (response) {
            console.log(_this.count = response.count);
            var countnum = "WMZ00" + _this.count;
            _this.registerForm.patchValue({ invoiceNumber: countnum });
        }, function (error) { console.log(error); });
        this.userRest.getCurentUser().subscribe(function (response) {
            console.log(_this.users = response.user);
            _this.registerForm.patchValue({ rate: response.user.rate });
        }, function (error) { console.log(error); });
        this.registerForm.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["distinctUntilChanged"])(this.isSame)).subscribe(function (values) {
            console.log(values);
            var rate = values.rate, hours = values.hours;
            _this.registerForm.patchValue({
                amount: (rate * hours)
            });
        });
    };
    Object.defineProperty(UserCreateComponent.prototype, "invoiceNumber", {
        get: function () { return this.registerForm.get('invoiceNumber'); },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(UserCreateComponent.prototype, "services", {
        get: function () { return this.registerForm.get('services'); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(UserCreateComponent.prototype, "printName", {
        get: function () { return this.registerForm.get('printName'); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(UserCreateComponent.prototype, "date", {
        get: function () { return this.registerForm.get('date'); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(UserCreateComponent.prototype, "signature", {
        get: function () { return this.registerForm.get('signature'); },
        enumerable: true,
        configurable: true
    });
    UserCreateComponent.prototype.isSame = function (prev, next) {
...
var UserEditComponent = /** @class */ (function () {
    ...
    UserEditComponent.prototype.ngOnInit = function () {
        ...
        this.userRest.editUser(id).subscribe(function (response) {
            _this.users = response.payment.user_details;
        ...
        this.updateUser.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["distinctUntilChanged"])(this.isSame)).subscribe(function (values) {
            console.log(values);
            var rate = values.rate, hours = values.hours;
            _this.updateUser.patchValue({
                amount: (rate * hours)
    ...
    UserEditComponent.prototype.isSame = function (prev, next) {
        return (prev.rate === next.rate)
            && (prev.hours === next.hours);
    };
    ...
    Object.defineProperty(UserEditComponent.prototype, "invoiceNumber", {
        get: function () { return this.updateUser.get('invoiceNumber'); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(UserEditComponent.prototype, "amount", {
        get: function () { return this.updateUser.get('amount'); },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(UserEditComponent.prototype, "hours", {
        get: function () { return this.updateUser.get('hours'); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(UserEditComponent.prototype, "services", {
        get: function () { return this.updateUser.get('services'); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(UserEditComponent.prototype, "printName", {
        get: function () { return this.updateUser.get('printName'); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(UserEditComponent.prototype, "date", {
        get: function () { return this.updateUser.get('date'); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(UserEditComponent.prototype, "signature", {
        get: function () { return this.updateUser.get('signature'); },
        enumerable: true,
        configurable: true
    });
    UserEditComponent.prototype.generatePDF = function () {
        var _this = this;
        var data = document.getElementById('tablecontent');
        console.log(data);
        html2canvas__WEBPACK_IMPORTED_MODULE_7___default()(data).then(function (canvas) {
            ...
            _this.userRest.updateUser(_this.updateUser, id).subscribe(function (response) {
                console.log(response),
                    _this.router.navigate(['invoice/list']);
            }, function (error) {
                _this.serverErrors = error.error.errors;
    ...
    UserEditComponent.prototype.showBasicDialog = function () {
        this.displayBasic = true;
        console.log();
    };
    UserEditComponent.prototype.showImage = function (data) {
        this.signatureImage = data;
        this.registerForm.patchValue({ signature: this.signatureImage });
        console.log(this.signatureImage);
        this.displayBasic1 = false;
...
var UserListComponent = /** @class */ (function () {
    ...
    UserListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.userRest.getInvoices().subscribe(function (response) { console.log(_this.timeSheets = response.timesheet); _this.loading = false; }, function (error) { console.log(error); });
    };
...
var UserRestService = /** @class */ (function () {
    ...
    UserRestService.prototype.getCurentUser = function () {
...
var UserViewComponent = /** @class */ (function () {
    function UserViewComponent(route, userRest, router) {
        this.route = route;
        this.userRest = userRest;
        this.router = router;
        this.serverErrors = [];
    ...
    UserViewComponent.prototype.isSame = function (prev, next) {
        return (prev.rate === next.rate)
            && (prev.hours === next.hours);
    };
    UserViewComponent.prototype.onSave = function () {
        this.displayBasic1 = true;
    };
    Object.defineProperty(UserViewComponent.prototype, "invoiceNumber", {
        get: function () { return this.registerForm.get('invoiceNumber'); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(UserViewComponent.prototype, "amount", {
        get: function () { return this.registerForm.get('amount'); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(UserViewComponent.prototype, "rate", {
        get: function () { return this.registerForm.get('rate'); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(UserViewComponent.prototype, "hours", {
        get: function () { return this.registerForm.get('hours'); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(UserViewComponent.prototype, "services", {
        get: function () { return this.registerForm.get('services'); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(UserViewComponent.prototype, "printName", {
        get: function () { return this.registerForm.get('printName'); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(UserViewComponent.prototype, "date", {
        get: function () { return this.registerForm.get('date'); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(UserViewComponent.prototype, "signature", {
        get: function () { return this.registerForm.get('signature'); },
        enumerable: true,
        configurable: true
    });
    UserViewComponent.prototype.generatePDF = function () {
        var _this = this;
        var data = document.getElementById('tablecontent');
        console.log(data);
        html2canvas__WEBPACK_IMPORTED_MODULE_6___default()(data).then(function (canvas) {
            ...
            var imgHeight = canvas.height * imgWidth / canvas.width;
            var contentDataURL = canvas.toDataURL('image/png');
            var pdf = new jspdf__WEBPACK_IMPORTED_MODULE_5__["default"]();
            var position = 5;
            pdf.addImage(contentDataURL, 'PNG', 0, position, imgWidth, imgHeight);
            pdf.save('invoice-payment.pdf');
            var id = _this.route.snapshot.params.id;
    ...
    UserViewComponent.prototype.showBasicDialog = function () {
        this.displayBasic = true;
        console.log();
    };
    UserViewComponent.prototype.showImage = function (data) {
        this.signatureImage = data;
        this.registerForm.patchValue({ signature: this.signatureImage });
        console.log(this.signatureImage);
        this.displayBasic1 = false;
    };
    UserViewComponent.prototype.updateUserDetails = function () {
        var _this = this;
        var id = this.route.snapshot.params.id;
        this.userRest.updateUser(this.updateUser, id).subscribe(function (response) {
            console.log(response),
...
/* harmony import */ var _ng_plus_signature_pad__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! @ng-plus/signature-pad */ "./node_modules/@ng-plus/signature-pad/fesm5/ng-plus-signature-pad.js");
...
//# sourceMappingURL=admin-admininvoice-user-module-es5.js.map