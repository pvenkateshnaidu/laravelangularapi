...
var UserListComponent = /** @class */ (function () {
    ...
    UserListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.userRest.getTimeSheet().subscribe(function (response) { console.log(_this.timeSheets = response.timesheet); _this.loading = false; }, function (error) { console.log(error); });
...
//# sourceMappingURL=admin-admintimesheet-user-module-es5.js.map